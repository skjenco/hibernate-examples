package com.iskj.standalonedatajpa.config;

import javax.persistence.EntityManagerFactory;
import javax.sql.DataSource;

import com.iskj.standalonedatajpa.MainBean;
...
@Configuration
@EnableJpaRepositories("com.iskj.standalonedatajpa.repository")
...
public class StandaloneDataJpaConfig {
	...
	public EntityManagerFactory entityManagerFactory() {
		...
		factory.setPackagesToScan("com.iskj.standalonedatajpa.model");
